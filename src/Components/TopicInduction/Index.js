            ...
            <div className='wrapper dashboard-main'>
                ...
                <div className='fullpage-layout'>
                    ...
                    {page === "listing" ? <div className='rightPanel'>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="cstm-icon-btn" data-toggle="modal" data-target="#myModal4">
                                                        ...
                                                        <a href="#" class="cstm-delete mrn-rt"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <ViewTopic />
                        : page === "add" ? <AddTopic /> : page === "edit" ? <EditTopic /> : <></>}
                </div>
            </div>
                        ...
                        <div class="modal-body modal-contentbody">
                            <form>
                                ...
                                <div className='col-12 cstm-ModalField'>
                                    ...
                                    <textarea type="text" placeholder='Enter module name'></textarea>
                                </div>
