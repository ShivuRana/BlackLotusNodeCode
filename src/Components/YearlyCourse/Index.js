...
const Index = () => {
        ...
        return (
          <>
            <button type="button" class="cstm-icon-btn" data-toggle="modal" data-target="#myModal3">
              <Link to={"/view-YearTopic/?id=" + row.cell.row.original._id} class="cstm-eye"><i class="fa fa-eye" aria-hidden="true"></i></Link>
            </button>

            <button type="button" class="cstm-icon-btn" data-toggle="modal" data-target="#myModal3">
              <Link to={"/edit-YearTopic/?id=" + row.cell.row.original._id} class="cstm-edit"><i class="fa fa-pencil" aria-hidden="true"></i></Link>
            </button>
  ...
  //create data function for get data this formate
  function createData(_id, name, description, topic_type, rating, createdAt, moduleId, action) {
    return {
      _id,
      name,
      description,
          ...
          <div class="modal-content">
            ...
            <div class="modal-body modal-contentbody">
              ...
              <div className='delete-btn'>
                <button className='cstm-deletebtn cstm-topic-update-btn' disabled={isLoading} onClick={handleDelete}>Delete</button>
