...
import ViewTopic from './ViewQuiz';
import AddTopic from './AddQuiz';
import EditTopic from './EditQuiz';
import ViewQuestion from './ViewQuestion';
import AddQuestion from './AddQuiz';
import EditQuestion from './EditQuestion.js';
import ViewQuestionImage from './ViewQuestionImage';
        ...
        <>
            <div className='wrapper dashboard-main'>
                ...
                <div className='fullpage-layout'>
                    ...
                    {page === "listing" ? <div className='rightPanel'>
                            ...
                            <div className='maintable'>
                                <div className='cstm-contentHeader'>
                                    ...
                                    <div className='cstm-search-createbtn'>
                                        <div class="dropdown">
                                            <button id="dLabel" className='cstm-moduldroupdown' type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Select Course
                        ...
                        <ViewTopic />
                        : page === "add" ? <AddTopic /> : page === "edit" ? <EditTopic /> : page === "viewquestion" ? <ViewQuestion /> : page === "addquestion" ? <AddQuestion /> : page === "editquestion" ? <EditQuestion /> : page === "viewquestionimage" ? <ViewQuestionImage /> : <></>}
                </div>
            </div>
                        ...
                        <div class="modal-body modal-contentbody">
                            <form>
                                <div className='col-12 cstm-ModalField main-modalfield'>
                                    ...
                                    <input type="text" placeholder='Enter quiz name'></input>
                                </div>
